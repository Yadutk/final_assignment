    ...
    public static void main( String[] args )
    {
        ...
        try{
           ...
           try(FileWriter writer = new FileWriter(csvfilename)){
               writer.append("customer_id,full_name,city,personal_phnum,personal_email,office_loc,subscription_date,pending_days,work_phnum,work_email\n");
           }
            ...
            while (rs.next()) {
                ...
                String office_loc = rs.getString("office_loc");
